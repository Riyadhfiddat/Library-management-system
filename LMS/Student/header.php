...
$result = mysqli_query(mysqli_connect('localhost','root','','lms'),"SELECT * FROM `students` where id= '$sid'");
while ($row = mysqli_fetch_assoc($result)) {?>
    <li> <a href="profile.php?updateprofile=<?=base64_encode($row['id'])?>"><i class="fa fa-user" aria-hidden="true"></i>Profile Update</a></li>
<!--    <li> <a href="profile1.php?profile=--><?//=base64_encode($row['id'])?><!--"><i class="fa fa-user" aria-hidden="true"></i>Profile</a></li>-->
                ...
                <div class="nano-content">
                    <nav>
                        <ul class="nav nav-left-lines" id="main-nav">
                            ...
                            <li class="<?= $page == 'books.php' ? 'active-item' :''?>"><a href="books.php"><i class="fa fa-book" aria-hidden="true"></i><span>Search Books</span></a></li>
